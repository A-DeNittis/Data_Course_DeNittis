...
perf <- ben_new_vec - katy_new_vec
perfdat = data.frame(YEARS = c(2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2010, 2011, 2012), ben_new_vec, katy_new_vec, perf)
which(perfdat$perf == min(perfdat$perf))
lowestyear = perfdat[1,1]
lowestyear
