...
# show reads
sread(fq.1) #Read sequences
reads.1 = sread(fq.1)
class(reads.1[1]) ##DNA stringset as class
...
library(dada2)  ## only works with fastq files, focuses on quality
...
setwd("C:/Users/Aly/Desktop/GIT/Data_Course/data/Fastq_16S/")
...
#How do you compare multiple species on same graph? Vegan package - condenses multiple axis
###ARIMA
