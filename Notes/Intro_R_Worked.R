...
bob = 3+4 # Here, it will evaluate 3 + 4, but it ignores everything after the hashtag on this line
...
otus = read.csv("C:/Users/Aly/Desktop/Data_Course/code_examples/R_Intro/otu_table.csv", as.is = TRUE, stringsAsFactors = FALSE,
         check.names = FALSE)
metadata = read.csv("C:/Users/Aly/Desktop/Data_Course/code_examples/R_Intro/otu_mapping.csv", as.is = TRUE, stringsAsFactors = TRUE,
         check.names = FALSE)
